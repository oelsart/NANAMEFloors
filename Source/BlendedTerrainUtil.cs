...
namespace NanameFloors
{
    ...
    public static class BlendedTerrainUtil
    {
        public static void MakeBlendedTerrain(TerrainMask terrainMask)
        {
            ...
            if (newTerr.modExtensions == null) newTerr.modExtensions = new List<DefModExtension>();
            newTerr.modExtensions.Add(terrainMask);
        ...
        private readonly static Dictionary<Type, HashSet<ushort>> takenHashesPerDeftype = (Dictionary<Type, HashSet<ushort>>)AccessTools.Field(typeof(ShortHashGiver), "takenHashesPerDeftype").GetValue(null);
    }
}