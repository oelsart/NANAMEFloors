...
namespace NanameFloors
{
    public static class BlendedTerrainUtil
    {
        public static void MakeBlendedTerrain(TerrainMask terrainMask)
        {
            ...
            newTerr.blueprintDef = bluePrintDef;
            ...
            newTerr.frameDef = frameDef;

            LongEventHandler.ExecuteWhenFinished(delegate
            {
                GraphicRequest req = new GraphicRequest(typeof(Graphic_Terrain), baseTerrain.texturePath, AddedShaders.TerrainHardBlend, Vector2.one, baseTerrain.DrawColor, coverTerrain.DrawColor, null, 0, null, "NanameFloors/" + terrainMask.maskTextureName);
                ...
                newTerr.graphicPolluted = GraphicDatabase.Get(typeof(Graphic_Terrain), path, shader, Vector2.one, baseTerrain.DrawColor, coverTerrain.DrawColor, "NanameFloors/" + terrainMask.maskTextureName);
