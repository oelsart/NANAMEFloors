...
public class TerrainMask : DefModExtension, IExposable
{
  ...
  public static string GetDefName(string maskTextureName, TerrainDef baseTerrain, TerrainDef coverTerrain,
    Rot4 rotation)
  {
  ...
  static TerrainMask()
  {
    ...
    static void Init()
    {
      ...
      NanameFloors.UI.terrainMasks =
        cachedTerrainMasks.Where(m => !NanameFloors.settings.exceptMaskList.Contains(m.name)).ToList();
    }
  }
